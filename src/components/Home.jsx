    ...
    <div data-aos="zoom-in" className='about-me md:grid-cols-2 grid grid-cols-1 grid' id='home'>
        ...
        <div className="about-me-contents flex justify-center items-center">
           <div className='flex md:justify-start md:items-start justify-center items-center flex-col'>
              ...
              <button type='button' className='btn w-auto text-white mt-5 w-[115px] bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 flex items-center gap-1'>
                View Resume
                </button>
           </div>
        </div>
        ...
        <div className="my-avatar flex md:justify-end items-center justify-center ">
            <img src={avatar} alt="avatar" className='object-cover object-fit max-w-[280px] mt-20' />
        </div>
